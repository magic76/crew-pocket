...
const BUILD_REVISION = 'auto-03e0b602fb8f';
...
const APP_SHELL = [
  ...
  "/css/style.css?v=1ce55fd5f774",
  "/css/style-premium.css?v=7b8b80b3a5c1",
  "/js/i18n.js?v=43acb0dc5acc",
  "/js/ui.js?v=ae2d96388692",
  "/js/tools.js?v=6ac4938ad601",
  "/js/storage.js?v=0e143c8da2fc",
  "/js/chat.js?v=d1753a8d6879",
  "/js/tasks.js?v=2e5e3f5e9e77",
  "/js/live.js?v=21194ec8d582",
  "/js/auth.js?v=a77731483ec0",
  "/js/app.js?v=0f8b46a89ffc",
  "/dompurify.min.js",
  "/icon-192.png",
  "/icon-512.png",
  "/icon.png",
