...
class ActiveSessionManager {
  ...
  async getOrCreateSession(targetConversationId, targetModel, targetEffort = 'low', targetWorkspace = '/data/data/com.termux/files/home') {
  ...
  prewarm(targetModel = 'gemini-3.7-flash', targetEffort = 'low', targetWorkspace = '/data/data/com.termux/files/home') {
