...
"`;
  ...
  // Start a known package or the Android Settings app.  Keeping this in the
  // helper avoids fragile launcher-coordinate guesses.
  async launchApp(packageName = '', target = '') {
    return this.sendAccessibilityRequest("/launch", { package: packageName, target });
  }
