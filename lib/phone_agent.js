...
"`;
  ...
  // Highlight Area or UI Element on Screen
  async highlightArea(left, top, right, bottom, label = "", duration = 3500) {
    return this.sendAccessibilityRequest("/highlight", { left, top, right, bottom, label, duration });
  }
