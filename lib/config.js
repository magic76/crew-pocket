...
const AVAILABLE_MODELS = [
  { id: 'gemini-3.7-flash-low', name: 'Gemini 3.7 Flash (極速版)', desc: '⚡ 秒級即時回應 · 對講機專用首選', icon: '⚡', badge: '最快', badgeColor: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/40' },
  { id: 'gemini-3.7-flash-high', name: 'Gemini 3.7 Flash (深度版)', desc: '🧠 深度邏輯推理 · 複雜編程架構', icon: '✨', badge: '推理', badgeColor: 'bg-indigo-500/20 text-indigo-300 border-indigo-500/40' },
