...
const AVAILABLE_MODELS = [
  ...
  { id: 'gpt-oss-120b', provider: 'antigravity', name: 'GPT-OSS 120B', desc: '千億級開源大模型', icon: '🟢', badge: '開源', badgeColor: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/40' },
  { id: 'codex-default', provider: 'codex', name: 'OpenAI Codex', desc: '本機 Codex CLI · 全自動權限', icon: '🧩', badge: 'Codex', badgeColor: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/40' }
];
