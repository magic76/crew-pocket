...
class CodexProvider {
  ...
  async startTurn({ conversationId, model, effort, prompt, imagePath, workspace, executionMode, executionPolicy, onEvent, onAbort }) {
    ...
    const userText = selfDebugContext + (liveMemoContext
      ? `${liveMemoContext}\n\n【目前使用者訊息】\n${governedPrompt}`
      : governedPrompt);
